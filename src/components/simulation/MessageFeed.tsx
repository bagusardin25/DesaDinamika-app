...
const THINKING_PHRASES = [
  "sedang berpikir...",
  "sedang merumuskan tanggapan...",
  "sedang mempertimbangkan situasi...",
        ...
        <CardContent className="relative p-6 space-y-5">
          ...
          {sparklinePath && (
            <div className="flex flex-col items-center gap-1">
              <span className="text-[10px] text-muted-foreground">Tren Kepuasan</span>
          ...
          <Link href={`/report?id=${simId}`} className="block">
            <Button className="w-full h-11 font-semibold shadow-lg shadow-primary/20">
              Lihat Laporan Lengkap <ArrowRight className="w-4 h-4 ml-2" />
            </Button>
          </Link>
        </CardContent>
      </Card>
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Simulasi mungkin telah kedaluwarsa atau server tidak dapat dihubungi.
              </p>
            </div>
            <Link href="/setup">
              <Button
          ...
          <>
            <div className="flex items-center justify-center my-6">
              <Badge variant="secondary" className="bg-green-500/10 text-green-500 border-none font-medium">
                ✅ Simulasi Selesai — Semua Minggu Telah Berakhir
              </Badge>
            </div>
            {outcome && (
              <OutcomeSummaryCard
