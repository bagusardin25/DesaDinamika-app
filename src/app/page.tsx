  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative bg-background antialiased overflow-x-hidden">
      ...
      <header className="fixed top-0 w-full p-4 md:p-6 flex justify-center z-50">
        <div className="w-full max-w-7xl flex justify-between items-center px-6 py-3 rounded-2xl border border-border/40 backdrop-blur-md bg-background/60 shadow-sm">
          <div className="flex items-center gap-3 group cursor-pointer">
            ...
            >
              <Image src="/logo.svg" alt="DesaDinamika Logo" width={28} height={28} className="object-cover scale-[1.15]" priority />
            </motion.div>
            <div className="flex items-center gap-2">
              <span className="font-bold text-xl tracking-tight text-foreground">DesaDinamika</span>
      ...
      <main className="z-10 flex flex-col items-center px-6 max-w-7xl mx-auto mt-24 md:mt-32 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 w-full items-center mb-24">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            >
              ...
              <span>{isHighPressure ? "Peringatan: Risiko Konflik Warga Tinggi" : "Platform Simulasi Kebijakan Desa Berbasis AI"}</span>
            </motion.div>
            ...
            <div className="relative mb-6 w-full">
              ...
              >
                Simulasi Kebijakan <br className="hidden md:block" />
                <span className={cn(
            ...
            >
              Uji coba kebijakan desa Anda dengan AI Warga Virtual. Mitigasi konflik dan hemat anggaran sebelum implementasi nyata.
            </motion.p>
          ...
          <div className="flex justify-center lg:justify-end w-full relative lg:-mt-16 xl:-mt-24">
            ...
            >
              <div className="flex justify-between items-center mb-6">
                <span className="text-sm font-bold uppercase tracking-widest text-muted-foreground">Indikator Kepuasan Warga</span>
                <span className={cn(
        ...
        >
          <FeatureCard 
            ...
            title="AI Warga Virtual"
            description="Simulasikan reaksi warga dari berbagai latar belakang (Petani, Pedagang, Pemuda)."
          />
          <FeatureCard 
            icon={<MessageSquare className="w-6 h-6" />}
            title="Stress-Test Kebijakan"
            description="Lihat dampak kebijakan Anda melalui debat balai desa virtual secara real-time."
            highlight
          />
          <FeatureCard 
            icon={<Activity className="w-6 h-6" />}
            title="Laporan Mitigasi"
            description="Dapatkan analisis risiko dan rekomendasi perbaikan sebelum kebijakan disahkan."
          />
        </motion.div>
        ...
        <section className="w-full mt-20 mb-32 relative">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-black tracking-tight mb-4">Masyarakat Virtual Anda</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">AI Persona warga yang dilatih untuk merespons kebijakan desa, mulai dari bantuan sosial hingga pembangunan infrastruktur.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <AgentCard 
              name="Pak Budi" 
              role="Petani" 
              traits={["Kritis", "Pragmatis", "Tokoh Warga"]} 
              description="Membutuhkan kepastian harga pupuk subsidi dan perbaikan saluran irigasi segera." 
            />
            <AgentCard 
              name="Bu Siti" 
              role="Pemilik UMKM" 
              traits={["Optimis", "Kalkulatif", "Adaptif"]} 
              description="Mendukung kebijakan pro-ekonomi, sangat vokal jika iuran pasar dinaikkan." 
            />
            <AgentCard 
              name="Andi" 
              role="Pemuda Desa" 
              traits={["Inovatif", "Vokal", "Tech-Savvy"]} 
              description="Sering protes lambatnya internet balai desa, tapi siap membantu program digitalisasi." 
            />
            <AgentCard 
              name="Mbah Yoso" 
              role="Sesepuh Desa" 
              traits={["Konservatif", "Dihormati", "Hati-hati"]} 
              description="Menjaga tradisi desa, akan menolak keras jika ada penggusuran tanah wakaf." 
            />
          </div>
        </section>
      ...
      <footer className="w-full py-12 border-t border-border/40 text-center text-muted-foreground text-sm font-medium">
        © 2026 DesaDinamika. Inovasi Tata Kelola Desa untuk GEMASTIK 2025.
      </footer>
    </div>
  );
}
