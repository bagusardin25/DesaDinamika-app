          ...
          <div className="flex items-center gap-6">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative w-8 h-8 flex items-center justify-center rounded-xl overflow-hidden bg-[#18181b] shadow-lg shadow-violet-500/20 border border-violet-500/30 group-hover:scale-105 transition-transform">
                <Image src="/logo.svg" alt="DesaDinamika Logo" width={22} height={22} className="object-cover scale-[1.15]" priority />
              </div>
      ...
      <div className="max-w-[1400px] mx-auto flex pt-16">
        ...
        <main className="flex-1 min-w-0 px-6 md:px-12 lg:px-16 py-12 pb-32">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            <strong className="text-foreground">DesaDinamika</strong> is a
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            DesaDinamika is built on a modern stack designed for real-time AI
...
└───────────────────────────────────────────────────────────┘`}
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            DesaDinamika supports two authentication methods for user accounts.
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            Each agent in DesaDinamika is a fully autonomous AI entity powered
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            DesaDinamika ships with 4 curated presets, but you can design fully
  ...
  └─→ Record metrics snapshot → Check end conditions → Next Round
       └─→ If final round or all resigned → Determine Outcome`}
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            After a simulation completes, DesaDinamika generates a comprehensive
          ...
          <p className="text-muted-foreground leading-relaxed mb-6">
            The DesaDinamika backend exposes a RESTful API with WebSocket support.
          ...
          <p className="text-muted-foreground leading-relaxed mb-6">
            Core data structures used across the DesaDinamika system:
          </p>
