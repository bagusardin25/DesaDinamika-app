  ...
  const exportToPDF = useCallback(async () => {
    ...
    try {
      ...
      const drawPageFooter = () => {
        ...
        pdf.text("DesaDinamika | AI-Powered Team Simulation", margin, pageHeight - 10);
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8 space-y-10" ref={reportRef}>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-4 text-sm text-muted-foreground">
          <p>Generated by <span className="text-foreground font-medium">DesaDinamika</span> • AI-Powered Team Simulation Platform</p>
          <Link href="/">
